...
| 1 | link:src/main/java/exercice/EfficaciteMeilleur.java[Efficacité meilleur java]| Java | Efficacité | Meilleur
| 2 | link:src/main/java/exercice/EfficacitePire.java[Efficacité pire java] | Java | Efficacité | Pire
| 3 | link:src/main/java/exercice/SimpliciteMeilleur.java[Simplicité meilleur java] | Java | Simplicité | Meilleur
| 4 | link:src/main/java/exercice/SimplicitePire.java[Simplicité pire java] | Java | Simplicité | Pire 
|==========================================================================
...
. Un IDE (par exemple Visual Studio Code
. Lancez le
. Ouvrez le dossier (repository)
. Dans l'onglet des extensions (à droite) cherchez et installez "Extension Pack for Java" ce qui vous téléchargera tout ce dont vous avez besoin
. Recherchez les fichiers de tests (dans analyse) 
. Remplacez les `YOUR_PATH` par le chemin d'accès au fichier java que vous voulez tester
. Exécutez le fichier java et laissez la magie opérer
